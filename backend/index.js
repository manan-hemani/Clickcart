...
mongoose.connect(
  "mongodb+srv://mananhemani:gems%241234%23@cluster0.n0yy0m7.mongodb.net/ClickCart"
);
...
// Schema for Creation of Products
...
app.post("/addproduct", async (req, res) => {
  ...
  if (products.length > 0) {
    let latest_product_array = products.slice(-1);
    let last_product = latest_product_array[0];
